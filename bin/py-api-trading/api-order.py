...
# This demonstrates getting the current price of an instrument and trading
...
# This sets up an order for the same price as above, which will execute a
# trade when the price crosses 0.994
